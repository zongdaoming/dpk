...
distiller = dict(
    type='DPK_Distiller',
    teacher_pretrained = 'teacher/retinanet_r152_fpn_2x_coco-39.9_20220414.pth',
    init_student = True,
    index=[1,2,3,4],
...
teacher_cfg = 'configs/retinanet/retinanet_r152_fpn_2x_coco.py'
mae_cfg = 'configs/distillers/dpk/dpk_retina_cfg.py'
