...
class WideResNet(nn.Module):
    ...
    def forward(self, x, is_feat=True, preact=True):
        out = self.conv1(x)
        f0 = out
        out = self.block1(out)
        f1 = out
        ...
        if is_feat:
            if preact:
                ...
                f3 = self.bn1(f3)
            return [f0, f1, f2, f3, f4], out #[32,32,16,8,1]16 32 64 128 128
        else:
            return out
