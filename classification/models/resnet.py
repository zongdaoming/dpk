...
from timm.models.helpers import build_model_with_cfg, load_checkpoint
...
default_cfgs = {
    ...
    'resnet18': _cfg(url='/mnt/lustre/qiuzengyu/distillation/pth/resnet18.pth'),
    'resnet18d': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet18d_ra2-48a79e06.pth',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet34': _cfg(
        url='/mnt/lustre/qiuzengyu/distillation/pth/resnet34.pth'),
    'resnet34d': _cfg(
    ...
    'resnet50t': _cfg(
        ...
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet101': _cfg(
        url='/mnt/lustre/qiuzengyu/distillation/pth/resnet101.pth',
        interpolation='bicubic', crop_pct=0.95),
    'resnet101d': _cfg(
...
def cifar_resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    """
    model_args = dict(block=BasicBlock, layers=[2, 2, 2, 2], num_classes = 100, **kwargs)
    return _create_resnet('resnet18', pretrained, **model_args)
...
def cifar_resnet34(pretrained=False, **kwargs):
    """Constructs a ResNet-34 model.
    """
    model_args = dict(block=BasicBlock, layers=[3, 4, 6, 3], num_classes = 100, **kwargs)
    return _create_resnet('resnet34', pretrained, **model_args)
...
def resnet_model(model_type):
    net = create_model(model_type,pretrained=False)
    state_dict = torch.load(default_cfgs[model_type]['url'])
